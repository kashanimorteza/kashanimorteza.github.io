...
<div>
<span class="red">توضیح ساده بیتکوین</span>
<div class="md4"></div>
<span>
...
<div class="md3"></div>
<span class="blue">حالا یه سوال! این عدد چگونه مشخص می‌‌شود ؟</span>
<div class="md4"></div>
<span>
...
<div class="md3"></div>
<span class="blue">حالا یه سوال! با این روند چند تا پول تولید خواهد شد ؟</span>
<div class="md4"></div>
...
<div class="md4"></div>
<div>
<span>یه فرمول ریاضی می گه :</span>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<span>...... + 2a = a + (a/2) + (a/4) + (a/8) + (a/16)</span>
</div>
<div class="md4"></div>
<div>
<span> حالا اگر a=۵۰ در نظر بگیریم، در آخر فقط می‌توان ۱۰۰ تا پول تولید کرد</span>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<span>........ + (50/16) + (50/8) + (50/4) + (50/2) = 100</span>
</div>
<div>
<span> اینجا گفته هر بار بعد از اینکه ۲۱۰ هزار تا اسکناس تولید شد عدد را نصف کن و عدد جدید را حک کن، پس کل پولی‌ که میشود تولید کرد ۲۱ میلون است</span>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<span>21/000/000 = 210/000 * 100</span>
</div>
<div class="md3"></div>
<span class="blue">این پول چقدر اصل است ؟</span>
<div class="md4"></div>
<span class="blue">تاریخچهٔ پول جایی‌ نوشته شده است که قابل تغییر نباشد؟</span>
<div class="md4"></div>
<span class="blue">آیا می‌‌شود از این پول کپی‌ گرفت؟</span>
</div>
</div>
